            ...
            {footerData.socials.map((social, index) => (
              <li key={index}>
                <Tippy content={social.label} placement="top">
                  ...
                  >
                    <div className="w-10 h-10 flex items-center justify-center rounded-full text-gray-900 bg-gradient-to-r from-cyan-400 to-fuchsia-400 shadow-md hover:scale-110 transition-all">
        ...
        <div>
          ...
          <form className="flex flex-col gap-2">
            <input
              ...
              className="px-4 py-2 rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/60"
            />
            <Tippy content="Subscribe to my newsletter!">
              <button
                ...
                className="px-6 py-3 rounded-full shadow-lg text-gray-900 bg-gradient-to-r from-cyan-400 to-fuchsia-400 font-medium flex items-center justify-center gap-2 transition-all transform hover:-translate-y-1 leading-none text-base"
              >
